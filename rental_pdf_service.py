...
def generate_rental_receipt_pdf(payment: dict, contract: dict = None, tenant: dict = None, config: dict = None):
    ...
    return render_invoice_document(
        payment, company=co, tenant_name=tenant_name, tenant_email=tenant_email,
        property_address=property_addr, contract_number=contract_num,
        period=f"{period_month} {period_year}", amount=amount, late_fee=late_fee,
        total=total_paid, paid=True, date=f"{payment_date} {payment_time}".strip(),
