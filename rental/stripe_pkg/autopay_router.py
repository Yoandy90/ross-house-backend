...
async def admin_list_autopay_configs(request: Request):
    ...
    async for c in cursor:
        items.append({
            ...
            "processor": c.get("processor", "stripe" if c.get("payment_method_id") else ""),
            "payment_method_id": c.get("payment_method_id", ""),
            "helcim_method_id": c.get("helcim_method_id", ""),
            "helcim_method_type": c.get("helcim_method_type", ""),
            "helcim_method_brand": c.get("helcim_method_brand", ""),
            "helcim_method_last4": c.get("helcim_method_last4", ""),
            "authorization_version": c.get("authorization_version", ""),
            "authorized_at": c.get("authorized_at"),
